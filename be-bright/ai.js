...
/******/ 	var hotCurrentHash = "5368913152136683a7b2"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bulbs_screen = __webpack_require__(8);
	
	var _bulbs_screen2 = _interopRequireDefault(_bulbs_screen);
	
	var _pig_screen = __webpack_require__(9);
	
	var _pig_screen2 = _interopRequireDefault(_pig_screen);
	
	var _info_screen = __webpack_require__(13);
	
	var _info_screen2 = _interopRequireDefault(_info_screen);
	
	var _video_screen = __webpack_require__(14);
	
	var _video_screen2 = _interopRequireDefault(_video_screen);
	
	var _special_announcement_screen = __webpack_require__(15);
	
	var _special_announcement_screen2 = _interopRequireDefault(_special_announcement_screen);
	
	var _level_one_screen = __webpack_require__(16);
	
	var _level_one_screen2 = _interopRequireDefault(_level_one_screen);
	
	var _level_two_screen = __webpack_require__(18);
	
	var _level_two_screen2 = _interopRequireDefault(_level_two_screen);
	
	var _level_three_screen = __webpack_require__(19);
	...
	var _5 = __webpack_require__(21);
	
	var _6 = _interopRequireDefault(_5);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var BeBright = React.createElement(skoash.Game, {
	    config: _config2.default,
	    screens: [_4.default, _title_screen2.default, _bulbs_screen2.default, _pig_screen2.default, _info_screen2.default, _video_screen2.default, _special_announcement_screen2.default, _level_one_screen2.default, _level_two_screen2.default, _level_three_screen2.default, _flip_screen2.default],
	    menus: {
	        quit: _6.default
	    },
...
/***/ function(module, exports) {
	...
	exports.default = function (props, ref, key) {
	    return React.createElement(
	        ...
	        React.createElement(skoash.Image, { src: CMWN.MEDIA.FRAME + "frame3-lightning.png", className: "hidden" }),
	        React.createElement(skoash.Image, { src: CMWN.MEDIA.SPRITE + "sprites-why.png", className: "hidden" }),
	        React.createElement(skoash.Image, { src: CMWN.MEDIA.FRAME + "frame4-smoke.png", className: "hidden" }),
	        React.createElement(skoash.Image, { src: CMWN.MEDIA.FRAME + "frame5-smoke.png", className: "hidden" }),
	        React.createElement(skoash.Audio, { ref: "vo", type: "voiceOver", src: CMWN.MEDIA.VO + "vo-3-1.mp3" }),
	        React.createElement(
	            "div",
	            { className: "title animated" },
	            React.createElement(
	        ...
	        skoash.mixins.SelectableReveal(props, {
	            media: [React.createElement(skoash.Audio, { type: "voiceOver", ref: "0", src: CMWN.MEDIA.VO + "vo-3-2.mp3", delay: 2000 }), React.createElement(skoash.Audio, { type: "voiceOver", ref: "1", src: CMWN.MEDIA.VO + "vo-3-3.mp3", delay: 2000 }), React.createElement(skoash.Audio, { type: "voiceOver", ref: "2", src: CMWN.MEDIA.VO + "vo-3-4.mp3", delay: 2000 }), React.createElement(skoash.Audio, { type: "voiceOver", ref: "3", src: CMWN.MEDIA.VO + "vo-3-5.mp3", delay: 2000 })],
	            selectables: [React.createElement(skoash.ListItem, { className: "animated", correct: true }), React.createElement(skoash.ListItem, { className: "animated", correct: true }), React.createElement(skoash.ListItem, { className: "animated", correct: true }), React.createElement(skoash.ListItem, { className: "animated", correct: true })],
	            reveals: [React.createElement(
	                "li",
	                null,
	                React.createElement(
	                    "p",
	                    null,
	                    "Light bulbs burn electricity!"
	                )
	            ), React.createElement(
	                "li",
	                null,
	                React.createElement(
	                    "p",
	                    null,
	                    "Making electricity burns fossil fuels!"
	                )
	            ), React.createElement(
	                "li",
	                null,
	                React.createElement(
	                    ...
	                    " to bad air quality and climate change!"
	                )
	            ), React.createElement(
	                "li",
	                null,
	                React.createElement(
	                    "p",
	                    null,
	                    "Leaving the lights on when",
	                    React.createElement("br", null),
	                    " you don\u2019t need them costs money!"
	                ),
	                React.createElement(
	                    "div",
	                    { className: "dollars" },
	                    React.createElement(skoash.Image, { src: CMWN.MEDIA.IMAGE + "dollar-sign.png" }),
	                    React.createElement(skoash.Image, { src: CMWN.MEDIA.IMAGE + "dollar-sign.png" }),
	                    React.createElement(skoash.Image, { src: CMWN.MEDIA.IMAGE + "dollar-sign.png" })
	                ),
	                React.createElement(
	...
	exports.default = function (props, ref, key) {
	    return React.createElement(
	        ...
	        _extends({}, props, {
	            ...
	            id: 'pig',
	            answers: ['saver'],
	            selectableList: [React.createElement(skoash.ListItem, { className: 'pig animated', 'data-ref': 'pig' }), React.createElement(skoash.ListItem, { className: 'bulb animated', 'data-ref': 'saver', correct: true })]
	        }),
	        React.createElement(skoash.Audio, { ref: 'vo', type: 'voiceOver', src: CMWN.MEDIA.VO + 'vo-4-1.mp3', 'pl-delay': 1000 }),
	        React.createElement(skoash.Audio, { ref: 'saver', type: 'voiceOver', src: CMWN.MEDIA.VO + 'vo-4-2.mp3' }),
	        React.createElement(skoash.Audio, { ref: 'pig', type: 'voiceOver', src: CMWN.MEDIA.EFFECT + 's-4-1.mp3', complete: true }),
	        React.createElement(skoash.Audio, { ref: 'correct', type: 'sfx', src: CMWN.MEDIA.EFFECT + 's-4-2.mp3' }),
	        React.createElement(
	            skoash.Component,
	            { ref: 'title', className: 'title animated' },
	            React.createElement(
	                'div',
	                null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectableScreen = function (_skoash$Screen) {
	    _inherits(SelectableScreen, _skoash$Screen);
	
	    function SelectableScreen() {
	        _classCallCheck(this, SelectableScreen);
	
	        return _possibleConstructorReturn(this, (SelectableScreen.__proto__ || Object.getPrototypeOf(SelectableScreen)).call(this));
	    }
	
	    _createClass(SelectableScreen, [{
	        key: 'selectRespond',
	...
	exports.default = SelectableScreen;
...
/***/ function(module, exports) {
	...
	exports.default = function (props, ref, key) {
	    return React.createElement(
	        ...
	        React.createElement(skoash.Audio, { ref: "vo", type: "voiceOver", src: CMWN.MEDIA.VO + "vo-6-1.mp3" }),
	        React.createElement(
	            skoash.Component,
	            { className: "info animated" },
	            React.createElement(
	                "div",
	                null,
	                "Let's learn Mr. Eco's Super Special",
	                React.createElement("br", null),
	                React.createElement(skoash.Image, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (props, ref, key) {
	    ...
	    return (0, _labyrinth_screen_component2.default)(props, ref, key, {
	        ...
	        vos: [React.createElement(skoash.Audio, { ref: 'instructions', type: 'voiceOver', src: CMWN.MEDIA.VO + 'instructions.mp3' }), React.createElement(skoash.Audio, { ref: 'level-up', type: 'voiceOver', src: CMWN.MEDIA.VO + 'level-up1.mp3' }), React.createElement(skoash.Audio, { ref: 'try-again', type: 'voiceOver', src: CMWN.MEDIA.VO + 'try-again.mp3', complete: true })],
	...
	var _labyrinth_screen_component = __webpack_require__(17);
