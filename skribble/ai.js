	      ...
	      return self.emit({
	        ...
	        opts = {
	          ...
	          callback: function callback() {
	            _this.refs['screen-canvas'].setMenu();
	            _this.refs['screen-item-drawer'].updateData();
	          }
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedComponentsItem_drawer01Js = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selectable01 = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedComponentsCanvas01 = __webpack_require__(23);
	
	var _sharedComponentsCanvas012 = _interopRequireDefault(_sharedComponentsCanvas01);
	
	var _sharedComponentsMenu01 = __webpack_require__(26);
	
	var _sharedComponentsMenu012 = _interopRequireDefault(_sharedComponentsMenu01);
	
	var _sharedComponentsSelectable01 = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _editable_asset01Js = __webpack_require__(24);
	...
	var Canvas = (function (_skoash$Component) {
	  ...
	  _createClass(Canvas, [{
	    ...
	    value: function checkItem(key, type) {
	      ...
	      return self.isInBounds(key, type) && (self.refs[type + '-' + key].state.can_overlap || !self.state[type + 's'].some(function (item, index) {
	        return key !== index && !self.refs[type + '-' + index].state.can_overlap && skoash.util.doIntersect(self.refs[type + '-' + key].state.corners, self.refs[type + '-' + index].state.corners);
	      }));
	    }
	  }, {
	    key: 'isInBounds',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _draggable01Js = __webpack_require__(25);
	  ...
	  _createClass(EditableAsset, [{
	    ...
	    value: function checkItem() {
	      ...
	      this.setCorners(function () {
	        ...
	        if (typeof _this.props.checkItem === 'function') {
	          valid = _this.props.checkItem(_this.props['data-ref'], _this.props.asset_type);
	
	          if (valid) {
	            _this.setState({
	              valid: valid,
	              lastValid: new Object(_this.state)
	            });
	          } else {
	            _this.setState({
	              valid: valid
	          ...
	          if (typeof _this.props.setValid === 'function') {
	            _this.props.setValid(valid);
	          }
	        }
	      });
	    }
	    ...
	    value: function getSize() {
	      ...
	      image.onload = function () {
	        ...
	        minDim = _this2.props.minDim || 40;
	        maxDim = _this2.props.maxDim || 400;
	        width = image.width;
	        height = image.height;
	
	        minScale = Math.max(minDim / width, minDim / height);
	        maxScale = Math.min(maxDim / width, maxDim / height, _this2.state.maxScale);
	    ...
	    value: function bootstrap() {
	      ...
	      _draggable01Js2['default'].prototype.bootstrap.call(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selectable01Js = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reveal01Js = __webpack_require__(30);
	...
	var SavedMessages = (function (_Selectable) {
	  ...
	  _createClass(SavedMessages, [{
	    ...
	    value: function renderThumb(item) {
	      ...
	      firstImg = item && item.rules && item.rules.items && item.rules.items[0] && item.rules.items[0].src ? item.rules.items[0].src : '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedComponentsSelectable01Js = __webpack_require__(21);
